...
module constants_module
  ...
  double precision, parameter :: h_planck = 6.62606896d-27  ! erg s
  ...
  ! physical parameters
  double precision, parameter :: E_rad = 1.d12 ! initial radiation energy density
  double precision, parameter :: T_0 = (E_rad/a_rad)**0.25d0
...
program analytic
  ...
  double precision :: P_simpsonrule
