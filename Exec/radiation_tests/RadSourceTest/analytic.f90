...
module constants_module
  ...
  double precision, parameter :: k_B      = 1.3806504d-16   ! erg / K
  double precision, parameter :: c_light  = 2.99792458d10   ! cm / s
  double precision, parameter :: sigma_SB = 5.670400d-5     ! erg/s/cm^2/K^4
  double precision, parameter :: a_rad    = 4.0d0*sigma_SB/c_light
  double precision, parameter :: m_p      = 1.672621637d-24 ! g

  ! problem parameters

  ! matter density
  double precision, parameter :: rho_ambient = 1.e-7   ! g / cm**3
  ...
  ! starting time
  double precision, parameter :: t_0 = 1.d-16   ! s

  ! starting radiation energy density
  double precision, parameter :: E_rad = 1.d12  ! erg / cm**3
  ...
  !double precision, parameter :: rhoe_i = 1.d9  ! erg / cm**3
  double precision, parameter :: rhoe_i = 1.d2  ! erg / cm**3
  ...
  double precision, parameter :: kappa_p = 4.d-8
...
function f(x,beta,eta) result (fval)
  ...
  double precision, intent(in)  :: x, beta, eta
...
program analytic
  ...
  double precision :: beta, c_v, eta
  double precision :: rhoe_f, rhoe, dlog_rhoe
  double precision :: t
