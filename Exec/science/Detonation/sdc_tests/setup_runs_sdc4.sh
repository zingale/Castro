...
CTU_CASTRO_EXEC=./Castro1d.gnu.ex
...
do
    ...
    do
        ...
        nohup ${CTU_CASTRO_EXEC} inputs.1d.sdc amr.plot_file=${rdir}_plt ${GLOBAL_RUNPARAMS} ${RUNPARAMS} castro.cfl=${c} amr.n_cell=${nz} >& out &
        cd ..
    done
done
