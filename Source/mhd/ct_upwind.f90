       ...
       do j = w_lo(2), w_hi(2)
          do i = w_lo(1), w_hi(1)
             ...
             ur_out(i,j,k,UFS:UFS+nspec-1,dir) = ur(i,j,k,UFS:UFS+nspec-1,dir) - &
                  0.5d0*dt/dx*(flxd1(i+d(1),j+d(2),k+d(3),UFS:UFS+nspec-1) - &
             ...
             ul_out(i,j,k,UMX,dir) = ul(i,j,k,UMX,dir) - &
                  0.5d0*dt/dx*(flxd1(i+d(1),j+d(2),k+d(3),UMX) - flxd1(i,j,k,UMX)) - &
                  0.5d0*dt/dx*(flxd2(i+d_2(1),j+d_2(2),k+d_2(3),UMX) - flxd2(i,j,k,UMX))
