...
\runparamNS{sdc\_extra\_iters}{castro} &  extra SDC iterations beyond what are formally needed & 0 \\
\rowcolor{tableShade}
...
\rowcolor{tableShade}
\runparamNS{sdc\_use\_analytic\_jac}{castro} &  do we use an analytic Jacobian? & 1 \\
